...
### 커밋은 절대 자동으로 진행하지 마세요!

```
❌ 금지: 자동 커밋, 임의 커밋
✅ 필수: 매번 사용자에게 "커밋할까요?"를 물어보기
```

**필수 절차:**

1. **작업 완료 후** → "커밋할까요?" 물어보기
2. **사용자 동의** → 커밋 메시지 제시 (한국어)
3. **단계별 커밋** → 한 번에 여러 커밋하지 않기 (기능별 단계별 커밋)
4. **사용자 최종 승인** → 커밋 진행

### 커밋 메시지 규칙

- 한국어로 작성
- Conventional Commits 형식 + 이모지
- 예시:
  - `📚 docs: README 개선 및 빠른 시작 가이드 추가`
  - `🔧 chore: 작업 추적 파일 업데이트`
  - `✨ feat: 새로운 기능 추가`
  - `🐛 fix: 버그 수정`
  - `♻️ refactor: 코드 리팩토링`
